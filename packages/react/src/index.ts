...
export type {TBodyProps, THeadProps, TableOptions, TableProps, TdProps, ThProps, TrProps} from './table/table.js';
...
export type {SegmentedControlItemProps, SegmentedControlProps} from './segmented-control/segmented-control.js';
