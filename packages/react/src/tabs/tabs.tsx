 ...
 */
export function TabList<T extends ElementType = 'div'>({className, ...props}: TabListProps<T>) {
  return (
...
export function TabPanel<T extends ElementType = 'div'>({className, ...props}: TabPanelProps<T>) {
  return (
